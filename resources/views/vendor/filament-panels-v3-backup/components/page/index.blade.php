    ...
    >
        ...
        <div
            @class([
                ...
                match ($subNavigationPosition) {
                    \Filament\Pages\Enums\SubNavigationPosition::Start, \Filament\Pages\Enums\SubNavigationPosition::End => 'md:flex-row md:items-start',
                    default => null,
                } => $subNavigation,
                'h-full' => $fullHeight,
            ])
        >
            @if ($subNavigation)
                ...
                @if ($subNavigationPosition === \Filament\Pages\Enums\SubNavigationPosition::Start)
                ...
                @if ($subNavigationPosition === \Filament\Pages\Enums\SubNavigationPosition::Top)
            ...
            @if ($subNavigation && $subNavigationPosition === \Filament\Pages\Enums\SubNavigationPosition::End)
